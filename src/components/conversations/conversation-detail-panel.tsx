...
import { flushPendingTaskLink } from "@/hooks/use-platform-composer"
    ...
    (
      ...
      void (async () => {
        try {
          ...
          // prompt goes out (see flushPendingTaskLink). On failure the intent
          // is kept so a later send can retry; the send itself is not blocked.
          await flushPendingTaskLink(tabId, newConversationId)
