...
// PLATFORM CUSTOM BEGIN: reset the separate platform-tab-slice store too so
// pending draft / task-link state doesn't leak between tests.
import { resetPlatformTabSlice } from "@/stores/platform-tab-slice"
// PLATFORM CUSTOM END.
...
function seedWorkspaceStore() {
  ...
  resetTabStore()
  // PLATFORM CUSTOM BEGIN: reset the platform-tab-slice store too.
  resetPlatformTabSlice()
  // PLATFORM CUSTOM END.
}
